      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-200">Each member of our team specializes in a specific task that helps us design any product you require, while still being a jack of all trades.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl text-black font-bold leading-snug tracking-tight mb-1">Initial Contact</h4>
              <h6 className="text-l text-blue-400 italic leading-snug tracking-tight mb-1">Role</h6>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl text-black font-bold leading-snug tracking-tight">Initial Contact</h4>
              <h6 className="text-l text-blue-400 italic leading-snug tracking-tight mb-1">Role</h6>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
